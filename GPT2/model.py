...
#from angels import Angel2, Angel1
#from poweradam import PowerAdam
#from drivers import Flame, Flame1
...
class GPT(nn.Module):
    ...
    def configure_optimizers(self, optimizer_name, weight_decay, learning_rate, betas, rho, device_type):
        ...
        # new PyTorch nightly has a new 'fused' option for AdamW that is much faster
            ...
            optimizer = opt_func(optim_groups, lr=learning_rate, betas=betas, rho=rho)
        elif optimizer_name == 'flame':
            optimizer = opt_func(optim_groups, min_lr=learning_rate, betas=betas, critical_snr=0.35)
        elif optimizer_name == 'flame1':
            optimizer = opt_func(optim_groups, min_lr=6e-5, max_lr=learning_rate, betas=betas)
        elif optimizer_name == 'focus':
            optimizer = opt_func(optim_groups, lr=learning_rate, betas=betas, gamma = rho) # changed from 0.2
        else:
